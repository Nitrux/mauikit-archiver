...
checkinstall -D -y \
	...
	--requires="libc6,libkf6archive6,libkf6coreaddons6,libkf6i18n6,libkf6iconthemes6,libqt6core6t64,libqt6gui6,libqt6qml6,libqt6quick6,libqt6quickcontrols2-6,libqt6quickshapes6,mauikit \(\>= 4.0.4\),mauikit-filebrowsing \(\>= 4.0.4\)" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
